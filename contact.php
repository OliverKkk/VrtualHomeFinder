...
<title>Kenya Virtual Homes | Contact us</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	&nbsp;<br />
	&nbsp;<br />
		<table width="353" height="198" border="0" cellpadding="0" cellspacing="0" bgcolor="#C2E2E2">
        <tr bgcolor="#E8F0EC">
          <td class="pageName" align="center"><span class="pageName">How to reach us:</span></td>
		</tr>

		<tr>
            <td class="bodyText" align="center" >contacts here 
              <address style="border:#999999 3px double; text-align:center; width:70%"><a href="mailto:evanoskill@kenyavirtualhomes.com"></a>
		  	</address>
			</td>
        </tr>
      </table>
	...
	<center>	
			...
			<img src="images/adverts/adv6.jpg" width="181" height="148" alt="ADVERTISEMENT SPACE "/>
			    <br>&nbsp;
			  <p>
			  ...
			  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="186" height="226" title="flash1">
                      ...
                      <embed src="flash/fl-ad5.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="94%" height="90%"></embed>
		      </object>
			   <br>&nbsp;
			  <p><img src="images/adverts/adv7.jpg" width="181" height="222" alt="ADVERTISEMENT SPACE "/><br>
		</center>			</td>
  </tr>
  <tr>
	...
	<a name="idSearch"></a>
	 <table width="100%" border="0" cellspacing="3" cellpadding="3" align="center" bgcolor="#E7F5F2" class="smallText" >
			  <tr class="subHeader" align="center" style=""> 
