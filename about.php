...
<title>Kenya Virtual Homes | About us</title>
 ...
 <tr>
	...
	<table width="353" height="198" border="0" cellpadding="0" cellspacing="0">
        <tr bgcolor="#E8F0EC">
		  ...
		  style="border-bottom:thin dotted #999999;">About Kenya Virtual Homes </span></td>
		</tr>

		<tr>
          <td class="bodyText" align="left"> Our business is created to help regular every day tenants have a reliable and dependant source of real estate information.
            <p>
		  As the business grows, we want to venture out completely to satisfy the needs of our clients.<br>
		  A series of well gathered information regarding real estate and tenant's needs,<br>
		  has been collected to ensure customer needs are met.
		  <p>
		  <span class="subHeader">Vision</span>
		  <br>
		  To  provide the ultimate housing solutions for Kenyans.
		  <p>
		  <span class="subHeader">Mission</span>
		  <br>To provide resourceful,honest,timely and<br>
		  top quality real estate information to all our <br>
		  esteemed clients for the betterment of our society.
		  <p ><a href="mailto:evanoskill@kenyavirtualhomes.com" id="footerText" style=" margin-bottom:10px; color:#0066FF;" >
		  Evans K.N. Githinji<br>
		  <i><b>Kenya Virtual Homes</b></i></a>		  
		  </td>
        </tr>
      </table>
	   <br />&nbsp;
	...
	<td width="190" valign="top" class="bodyText">
	<br />&nbsp;
	<center><span class="subHeader">ADVERTS</span></center>
		...
		<center>	
				    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="186" height="226" title="flash1">
                      ...
                      <embed src="flash/fl-ad3.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="94%" height="90%"></embed>
		      </object>
			  
			  <br>&nbsp;
			  <p><img src="images/adverts/adv2.jpg" width="181" height="148" alt="ADVERTISEMENT SPACE "/>
			  
			   <br>&nbsp;
			  <p><img src="images/adverts/adv3.jpg" width="181" height="222" alt="ADVERTISEMENT SPACE "/>
			  <br>
		</center>			</td>
  </tr>
  <tr>
